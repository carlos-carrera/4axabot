...
Under the terms License to Use, “Licensee” means the AXA Entity using the
Licensed Products, “Licensor” means AXA Group Solutions Spain SL.
 
1   Definitions
 
“Licensee” means the Customer.
 
“Licensor” means AXA Group Solutions Spain SL.
 
“Software” or “Licensed Product” means the software, its documentation and any
associated components licensed hereunder.
...
“Users”: mean any physical or legal person authorized by Licensee to Use the
...
evaluating the Licensed Products in the territory where Licensee is doing
business. This right is granted for the term of the present License to Use.
...
Licensor shall defend, hold harmless and indemnify Customer from and against
any liability arising out of a claim by a third-party that the Licensed
Products infringes, misappropriates or violates such third-party’s intellectual
property rights.
 
If any Licensed Products become the subject of any such third-party claim, then
Licensor (at its choice) may either: (i) procure the right for the Customer to
continue using the Licensed Products as contemplated hereunder; (ii) modify the
Licensed Products to render it non-infringing; or (iii) replace the Licensed
Products with non-infringing Licensed Products. If none of the foregoing are
practicable, then Licensor shall be entitled to terminate the License to Use.
